...
impl ChipCore {
    ...
    const SCHIP_FONT_OFFSET: usize = 80;
    ...
    pub fn new() -> Self {
        ...
        chip_core.ram[..Self::FONT_DATA.len()].copy_from_slice(&Self::FONT_DATA);
        ...
        match opcode & 0xF000 {
            ...
            0xF000 => {
                match opcode & 0x00FF {
                    ...
                    0x0030 => {
                        self.i_reg = Self::SCHIP_FONT_OFFSET as u16 + ((self.regs[x()] & 0xF) * 10) as u16;
                    }
                    0x0033 => {
